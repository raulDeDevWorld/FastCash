    ...
    switch (theme) {
        ...
        case 'Primary':
            return <button
                ...
                className={`text-black inline-block hover:bg-gray-950 border-[1px] border-gray-50  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-[14px]  w-[100%] sm:max-w-[380px] px-5 py-3 text-center cursor-pointer`} 
