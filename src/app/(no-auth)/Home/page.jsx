...
export default function Home() {
    ...
    return (
        <main className='w-full h-full pt-[20px] bg-gray-50'>
            {
            ...
            <button className='fixed text-[20px] text-gray-500 h-[50px] w-[50px] rounded-full inline-block left-[0px] top-0 bottom-0 my-auto bg-[#00000010] z-20 lg:left-[8px]' onClick={prev}>{'<'}</button>
            <button className='fixed text-[20px] text-gray-500 h-[50px] w-[50px] rounded-full inline-block right-[0px] top-0 bottom-0 my-auto bg-[#00000010] z-20 lg:right-[8px]' onClick={next}>{'>'}</button>
            ...
            <div className="w-full   relative overflow-auto shadow-2xl bg-gray-50 scroll-smooth" ref={refFirst}>
                {item === 'Casos de Cobranza' &&
                    <table className="w-full min-w-[2500px] border-[1px] bg-white text-[14px] text-left text-gray-500 border-t-4 border-t-gray-400">
                        <thead className="text-[10px] text-gray-700 uppercase bg-gray-100">
                            {<tr className=''>
                            ...
                            {refunds.map((item, index) => (
                                ...
                                item.numeroMovil.includes(filter['Número de teléfono']) && item.nombreProducto.includes(filter.nombreProducto === 'Todo' ? '' : filter.nombreProducto) && item.estado.includes(filter['Estado de reembolso'] === 'Por favor elige' ? '' : filter['Estado de reembolso'].toLowerCase()) && item.diasAtraso * 1 <= filter['Maximo dias vencido'] && item.diasAtraso * 1 >= filter['Minimo dias vencido'] && <tr key={index} className='text-[12px] border-b'>
                                    <td className="px-3 py-2 text-[10px]">
                                        {console.log(filter['Maximo dias vencido'])}
                                        <a
                                    ...
                                    <td className="px-3 py-2"><Link href={`/Home/Datos?seccion=info`} className='text-blue-500 underline'>{item.numeroPrestamo}</Link></td>
                                ...
                                item.numeroMovil.includes(filter['Número de teléfono']) && item.nombreProducto.includes(filter.nombreProducto === 'Todo' ? '' : filter.nombreProducto) && item.estado.includes(filter['Estado de reembolso'] === 'Por favor elige' ? '' : filter['Estado de reembolso'].toLowerCase()) && item.diasAtraso * 1 <= filter['Maximo dias vencido'] && item.diasAtraso * 1 >= filter['Minimo dias vencido'] && <tr key={index} className='text-[12px] border-b'>
                                    ...
                                    <td className="px-3 py-2">
                                        <div className=' flex space-x-2'>
                                            <Link href={`/Home/Datos?seccion=info`} className=''>
                                                {/* <button type="button" class="w-full flex text-white bg-gradient-to-br from-blue-600 to-blue-400 hover:bg-gradient-to-bl foco-4 focus:outline-none foco-blue-300 dark:foco-blue-800 font-medium rounded-lg text-[10px] px-5 py-.5 text-center me-2 mb-2"> */}
                                                <UserCircleIcon className='h-6 w-6 fill-[#ebbb40]' />
                                                {/* </button> */}
                                            </Link>

                                            {/* <button type="button" class="w-full text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br foco-4 focus:outline-none foco-cyan-300 dark:foco-cyan-800 font-medium rounded-lg text-[10px] px-5 py-.5 text-center me-2 " onClick={() => setModal(true)}> */}
                                            ...
                                            {/* </button> */}
                                            {/* <button type="button" class="w-full flex text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br foco-4 focus:outline-none foco-cyan-300 dark:foco-cyan-800 font-medium rounded-lg text-[10px] px-5 py-.5 text-center me-2 mb-2" onClick={() => setModal(true)}> */}
                ...
                {item === 'Flujo de Clientes' && <div>
                    ...
                    <table className="w-full min-w-[1000px] border-[1px] bg-white text-[14px] text-left text-gray-500 border-t-4 border-t-gray-400">
                        <thead className="text-[10px] text-gray-700 uppercase bg-gray-200">
                            <tr className=''>
                            ...
                            <tr className=''>
                                ...
                                <th scope="col" className=" px-3 py-1 text-center text-blue-500">
                                    {getDay((0)).val}
                                </th>
                                <th scope="col" className=" px-3 py-1 text-center">
                                    {getDay((1)).val}
                        ...
                        <tbody>
                            {filtro_1.map((item, index) => (
                                item !== 'Todo' && <tr key={index} className='text-[12px] border-b'>
            ...
            {item === 'Registro Histórico' && (
                <div className="w-full   relative overflow-auto shadow-2xl bg-gray-50 scroll-smooth" ref={refFirst}>                    <table className="w-full min-w-[1500px] border-[1px] bg-white text-[14px] text-left text-gray-500 border-t-4 border-t-gray-400">
                    <thead className="text-[10px] text-gray-700 uppercase bg-gray-100">
                        <tr>
                            <th scope="col" className="px-3 py-3">Descripción de la excepción</th>
                            <th scope="col" className="px-3 py-3">Apodo del usuario</th>
                            <th scope="col" className="px-3 py-3">Código del producto</th>
                            <th scope="col" className="px-3 py-3">Código de operación</th>
                            <th scope="col" className="px-3 py-3">Contenido de la operación</th>
                            <th scope="col" className="px-3 py-3">Resultados de la operación</th>
                            <th scope="col" className="px-3 py-3">Tiempo de operación</th>
                        </tr>
                    </thead>
                    <tbody>
